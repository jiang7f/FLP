...
flp_problems_pkg, flp_configs_pkg = generater.generate_flp(0, [(3, 3), (3, 4)], 1, 20)
gcp_problems_pkg, gcp_configs_pkg = generater.generate_gcp(4, [(4, 2), (4, 3)], 1, 20)
kpp_problems_pkg, kpp_configs_pkg = generater.generate_kpp(0, [(8, 3, 7), (9, 3, 8)], 1, 20)
