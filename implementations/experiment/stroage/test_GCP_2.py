...
for num_layers in num_layers_range:
    for gcp in problems:
        ...
        row = [f'{gcp.num_graphs}, {gcp.pairs_adjacent}', num_layers, gcp.num_variables, len(gcp.linear_constraints)]
        ...
        for method in methods:
            ...
            ARG, in_constraints_probs, best_solution_probs = gcp.optimize(optimizer_option, circuit_option)
...
csv_filename = 'gcp_results_evaluation.csv'
