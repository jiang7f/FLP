    ...
    def get_feasible_solution(self):
        ...
        for i in range(1 << len(self.variables)):
            ...
            if all([np.dot(bitstr,constr[:-1]) == constr[-1] for constr in self.constraints]):
                return bitstr
        return
    def optimize(self, params_optimization_method='Adam', max_iter=30, learning_rate=0.1, num_layers=2, need_draw=False, beta1=0.9, beta2=0.999, use_Ho_gate_list=False, use_decompose=False, circuit_type='pennylane',mcx_mode='linear') -> None: 
