...
def train_non_gradient(optimizer_option: OptimizerOption):
    ...
    def callback(params):
        ...
        if iteration_count % 10 == 0:
            print(f"Iteration {iteration_count}, Result: {optimizer_option.cost_function(params)}")
    ...
    return train_with_scipy(params, optimizer_option.cost_function, optimizer_option.max_iter)