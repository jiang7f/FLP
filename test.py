...
# flp.set_algorithm_optimization_method('cyclic', 400)
flp.optimize( params_optimization_method='COBYLA', max_iter=150,num_layers=5, need_draw=True, use_Ho_gate_list=True, use_decompose=True, circuit_type='qiskit', debug=True)
